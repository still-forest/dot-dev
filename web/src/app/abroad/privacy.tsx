      ...
      <Paragraph>
        ...
        <ul className="mt-2 list-disc pl-8">
          ...
          <li>
            ...
            app. PostHog does not collect personally identifiable information. See PostHog's privacy policy for details:{" "}
            <Link to="https://posthog.com/privacy">https://posthog.com/privacy</Link>
          </li>
        </ul>
      </Paragraph>
